  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          {/* 1st block */}
          <div className="space-y-2 sm:col-span-12 lg:col-span-4 text-center lg:text-left">
            <div className="flex justify-center lg:justify-start">
              <Logo />
            </div>
            <div className="text-sm text-gray-600">
              &copy; ViralMind - Tous droits réservés.
            </div>
          </div>
      ...
      {/* Big text */}
      <div className="relative -mt-4 h-60 w-full overflow-hidden" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[100px] sm:text-[200px] md:text-[300px] lg:text-[348px] font-bold leading-none before:bg-linear-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['Viral'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Viral'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div

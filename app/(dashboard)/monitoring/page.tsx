      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
           {/* Platform select */}
           <div className="relative flex items-center bg-white border border-slate-100 rounded-2xl p-1 shadow-sm shrink-0">
             ...
             <select 
               ...
               className="w-full bg-slate-50 border-0 rounded-xl pl-10 pr-8 py-3.5 text-xs font-bold text-slate-600 focus:ring-0 outline-hidden cursor-pointer appearance-none"
             >
           ...
           {/* Input & Add Button */}
           <div className="flex items-center gap-2 bg-white border border-slate-100 rounded-2xl p-2 shadow-sm w-full sm:w-auto">
              <input 
                value={handle}
                onChange={(e) => {
                ...
                className="bg-transparent border-0 px-2 py-3 text-sm font-medium focus:ring-0 outline-hidden flex-1 sm:w-48"
              />
              <button 
                onClick={handleAddAccount}
                disabled={loading}
                className="bg-indigo-600 hover:bg-indigo-500 text-white p-3 rounded-xl transition-all active:scale-95 shrink-0"
              >
